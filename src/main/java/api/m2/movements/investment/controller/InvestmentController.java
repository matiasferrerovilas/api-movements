...
import api.m2.movements.investment.services.valuation.InvestmentValuationService;
...
public class InvestmentController {
    ...
    @Operation(summary = "Valuación actual de las inversiones del workspace")
    @GetMapping("/valuation")
    public List<InvestmentValuationRecord> getValuation() {
        return investmentValuationService.getValuations();
    }
